...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-teal-100 selection:text-teal-900">
        ...
        <div className="container mx-auto px-4 max-w-7xl relative z-10">
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-7xl font-black tracking-tight text-white mb-8 leading-[1.1]">
              ...
              <span className="text-teal-400">cómo está tu cuerpo de verdad?</span>
            </h1>
            {/* CAMBIO 4: Subheadline nuevo con hallazgos específicos + 60 seg + precio */}
            ...
            {[
              {
                ...
                // CAMBIO 5: Descripción con hallazgos específicos reales
                desc: "Detecta hígado graso, proteína en orina, problemas óseos y desequilibrios digestivos — antes de que se conviertan en problemas mayores."
              },
              {
      ...
      {/* CAMBIO 6: Sección de prueba social (nueva) */}
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="flex-1">
                ...
                <div className="space-y-6">
                  <p className="text-slate-500 font-semibold">Preguntas frecuentes:</p>
                  <div className="space-y-4">
                    {/* CAMBIO 8: Preguntas que atacan la objeción de incredulidad */}
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
                      <p className="text-slate-700">
                        <span className="italic text-slate-500">"¿El escáner biocuántico realmente funciona?"</span>
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
                      <p className="text-slate-700">
                        <span className="italic text-slate-500">"¿En qué se diferencia de un estudio clínico normal?"</span>
                      </p>
                    </div>
                    <div className="flex items-start gap-3">
                      <CheckCircle className="w-5 h-5 text-emerald-500 mt-1 flex-shrink-0" />
                      <p className="text-slate-700">
                        <span className="italic text-slate-500">"¿Qué detecta exactamente el análisis?"</span>
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div {...fadeInUp}>
              ...
              {/* CAMBIO 9: Eliminar "de lanzamiento" */}
              <p className="text-gray-300 mb-8 text-lg">
                Únete a esta jornada exclusiva de salud preventiva. Evaluaremos tu estado enfocándonos en los sistemas hormonal, digestivo, cardiovascular e inmunitario — con resultados al instante.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg text-white">Contacto directo</h4>
                    <p className="text-gray-400">Cindy Gómez — Atención y Soporte</p>
            ...
            <motion.div {...fadeInUp} className="bg-white text-gray-900 p-8 rounded-2xl shadow-xl">
              ...
              <ul className="space-y-3 mb-8">
                {[
                  // CAMBIO 11: "Escaneo de 4 sistemas" → "Hasta 52 reportes"
                  "Hasta 52 reportes de tus sistemas",
                  "Resultados inmediatos en el acto",
                  "Asesoría personalizada post-análisis",
                  "Sin dolor, sin agujas, sin molestias"
                ].map((item, i) => (
      ...
      {/* CAMBIO 13: Sección "Promotion Card" duplicada eliminada */}
